                ...
                <form role="form">
                   ...
                   <div class="row">
                    <div class="col-sm-6">
                      ...
                      <div class="form-group">
                        ...
                        <input type="date" class="form-control" placeholder="Enter ..." required="">
                      </div>
                    </div>
                    <div class="col-sm-6">
                      <div class="form-group">
                  ...
                  <div class="form-group">
                    <label for="inputName">Membership ID Number <b style="color: red;">*</b></label>
                     <input type="text" class="form-control" name="effectivity" id="effectivity" required>
                  </div>
                    ...
                    <div class="col-sm-6">
                      ...
                      <div class="form-group">
                        <label for="inputName">Email<b style="color: red;">*</b></label>
                              <input type="email" class="form-control" name="effectivity" id="effectivity" required>
                      </div>
                    </div>
                    <div class="col-sm-6">
                      <!-- textarea -->
                      <div class="form-group">
                        <label for="inputName">Phone Number<b style="color: red;">*</b> </label>
                              <input type="text" class="form-control" name="cp_no" id="cp_no" onkeypress="javascript:return isNumber(event)" pattern="^[0-9]{10,12}$"  maxlength="11" required>
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
