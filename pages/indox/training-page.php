...
<body class="landing-page sidebar-collapse">
        ...
        <div class="container">
            ...
            <div class="navbar-translate" >
                <a class="navbar-brand"  rel="tooltip"   data-placement="bottom" target="">
                    <b>Philippine Red Cross - OERMS</b>
                </a>
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navigation" data-nav-image="assets/img/blurred-image-1.jpg">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link" href="landing-page"><b>Home</b></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="training-page.php"><b>Trainings</b></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="about-page"><b>About</b></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="developer-page"><b>The Developer</b></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="../login/login"><b>Login</b></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="../registration/register"><b>Registration</b></a>
                    </li>
    ...
    <div class="wrapper">
        <div class="page-header page-header-small">
            <div class="page-header-image" data-parallax="true" style="background-image: url('assets/img/bgrc1.jpg');">
            </div>
            <div class="container">
                <div class="content-center">
                    <h3 class="title">Always First, Always Ready, Always There.</h3>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 ml-auto mr-auto text-center">
                        ...
                        <h7 class="description" style="color: black;"><b>Established officially in 1947, but with roots that traces back to the revolutionary days, the Philippine Red Cross has truly become the premier humanitarian organization in the country, committed to provide quality life-saving services that protect the life and dignity especially of indigent Filipinos in vulnerable situations.
                        <br><br>
                        ...
                        <br><br>
                        We take pride in urging all Filipinos to take part in the heroism of the Philippine Red Cross by becoming a full-fledged member, volunteer, or donor. For more information, please call our hotline 143 or 111-1111, 09123456789 or browse through our website.</b></h7>
                    </div>
                </div>
        ...
        <footer class="footer footer-default">
            <div class="container">
                ...
                <div class="copyright">
                    ...
                    </script><a href="#"> Team United </a>.</strong> All rights
      reserved.
