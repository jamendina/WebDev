                ...
                <div class="card-body">
                  <div class="tab-content clearfix">
                    <div class="active tab-pane" id="TEList">
                      ...
                      <!--<button type="submit" class="btn waves-effect waves-light btn-secondary btn-sm" data-target="#addAT" data-toggle="modal"><i class="fa fa-plus"></i> Add Training</button>-->
                       <?php include "AddTrainingModal.php"; ?>
                    </div>
                  <!-- /.tab-pane -->
                         ...
                         <?php $equery = mysqli_query($con, "SELECT * from tblevents
                            ...
                            { 
                              ...
                              $word_date3 = date('F j, Y', $old_date_timestamp3);
                                ...
                                ';
                                include "InstructorAssignModal.php";
                            }
                           ...
                           $iquery = mysqli_query($con, "SELECT *, tt.assignment_id as assignment_id from tblassignment tt 
                            ...
                            while($row = mysqli_fetch_array($iquery))
                            {
                                ...
                                <tr>
                                    ...
                                    <td>
                                    <a href="TraineeEvaluation.html?id='.$row['te_id'].'" type="button" target="_blank" class="btn btn-primary btn-sm btn" data-target="#blank'.$row['te_id'].'"><i class="fa fa-eye"></i></a>
                                    </button>
                                    </td>
